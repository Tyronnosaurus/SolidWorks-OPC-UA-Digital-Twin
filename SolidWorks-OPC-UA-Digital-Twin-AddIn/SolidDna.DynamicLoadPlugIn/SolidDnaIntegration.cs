...
namespace SolidDna.DynamicLoadPlugIn
{
    ...
    public class SolidDnaAddinIntegration : AddInIntegration
    {
        ...
        {
            PlugInIntegration.AddPlugIn<CustomPropertiesSolidDnaPlugin>();
            //PlugInIntegration.AddPlugIn(@"C:\Users\Eduard\Desktop\solidworks-api\Tutorials\05-DynamicPlugInReload\SolidDna.DynamicLoadPlugIn\bin\Debug\SolidDna.DynamicLoadPlugIn.Main.dll");
        }
        ...
        public override void PreConnectToSolidWorks()
        {
            ...
            //
            PlugInIntegration.UseDetachedAppDomain = false; //true;
        }
